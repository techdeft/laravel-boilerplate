...
<div class="p-6 max-w-5xl mx-auto space-y-6">
    <div class="flex items-center gap-4 bg-white p-6 rounded-2xl ">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm">Fill in the details below to add a new item to your inventory.</p>
        </div>
    </div>
    ...
    <form wire:submit.prevent="save" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-8 rounded-2xl  space-y-6">
                <div class="space-y-2">
        ...
        <div class="space-y-6">
            ...
            {{-- Organization Card --}}
            <div class="bg-white p-6 rounded-2xl  space-y-5">
            ...
            <div class="bg-white rounded-3xl w-full max-w-5xl h-[85vh] flex flex-col shadow-2xl overflow-hidden scale-up">
                <div class="p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    ...
                    <button @click="$wire.set('showMediaLibrary', false)"
                        class="p-3 bg-white hover:bg-red-50 hover:text-red-500 rounded-2xl transition-all ">
                        <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
