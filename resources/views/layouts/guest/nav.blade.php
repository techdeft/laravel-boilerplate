...
<header class="flex flex-wrap lg:justify-start lg:flex-nowrap z-50 w-full py-7 bg-navbar">
    <nav
        ...
        <div class="flex items-center gap-x-1 lg:gap-x-2 ms-auto py-1 lg:ps-6 lg:order-3 lg:col-span-3">
            <button type="button"
                class="size-9.5 relative flex justify-center items-center rounded-xl bg-layer border border-layer-line text-layer-foreground hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
        ...
        <div id="hs-pro-hcail"
            ...
            <div
                ...
                <div>
                    <a class="relative inline-block text-foreground focus:outline-hidden before:absolute before:bottom-0.5 before:start-0 before:w-full before:h-1 before:bg-primary"
                ...
                <div>
                    <a class="relative inline-block text-foreground focus:outline-hidden " href="#">Confirmation</a>
                </div>
            </div>
        </div>
        <!-- End Collapse -->
